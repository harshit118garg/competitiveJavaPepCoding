...
/*
    1• You are given n number of bulbs.
        ...
        and so on.
        You've to find which bulbs will be switched on
        after n fluctuations.

    2• Take as input a number n, representing the number of bulbs.
    3• Print all the bulbs that will be on
         after the nth fluctuation in voltage.
*/
